  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="989" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>宠物列表</b></td>
...
<table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" height="60"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#E6E6E6">
              <tr bgcolor="#eeeeee">
                <td width="40%" height="24" align="center">名称</td>
...
for(int i=1;i<=pagesize;i++){
	  ...
	  String newGood=rs.getInt("newGood")==0 ? "否":"是";
	  String sale=rs.getInt("sale")==0 ? "否":"是"; 
	  %>

              <tr style="padding:5px;">
                <td height="20" align="center"><a href="book_detail.jsp?ID=<%=ID%>"><%=goodName%></a></td>
