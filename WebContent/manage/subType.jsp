  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td colspan="3" class="tableBorder_B_dashed"><img src="images/manage_ico2.GIF" width="11" height="11">&nbsp;<a href="sub_add.jsp">[Add subcategory information]</a></td>
        <td width="12">&nbsp;</td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
      ...
      <tr>
        ...
        <td width="1089" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>List of sub categories</b></td>
        <td width="10" background="images/manage_leftTitle_right.GIF">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table>
	<!---->
               <form action="${pageContext.request.contextPath}/subType/del.action" method="post" name="frm">
                ...
                <tr> 
                  <td valign="top"> <table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0"> </table> 
                    <table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#E6E6E6"> 
                      <tr bgcolor="#eeeeee"> 
                        <td width="48%" height="24" align="center">Name of super category information</td>
                        <td width="44%" align="center">Name of the subcategory</td>
