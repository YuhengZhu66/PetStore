...
<body>
 <table width="100%" height="545" border="0" cellpadding="0" cellspacing="0">
   <tr>
     <td style="background-image:url(images/managerlogin_bg2.png);"> <form name="form1" method="post" action="${pageContext.request.contextPath}/admin/login.action" onSubmit="return checkM(form1)">
      <table width="448" height="345"  border="0" align="center"  style="margin-top:170px;" cellpadding="0" cellspacing="0" background="images/table.png">
        <tr>
        ...
        <tr>
          ...
          <table style="margin-top:30px" width="88%" height="240"  border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="57" align="center"><input name="Submit" type="submit" class="login_ok" value="Login">
                &nbsp;
                <input name="Submit2" type="reset" class="login_reset" value="Reset">
            </tr>
            <tr>
              <td height="35" align="right">
                <a href="../front/index.jsp"><img src="images/back.png"> Return to mall home page</a></td>
            </tr>            
          </table></td>
        </tr>
</table>
      <table width="491" height="39" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" >Online pet shop backstage management system</td>
        </tr>
      </table>
     </form></td>
   </tr>
